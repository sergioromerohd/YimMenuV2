...
namespace YimMenu
{
	void DefaultStyle()
	{
		...
		style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.35f, 0.50f, 0.70f, 0.75f);
		style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.47f, 0.62f, 0.85f, 0.85f);
		...
		style.Colors[ImGuiCol_Tab] = ImVec4(0.30f, 0.45f, 0.70f, 0.85f);
		style.Colors[ImGuiCol_TabHovered] = ImVec4(0.40f, 0.55f, 0.80f, 0.85f);
		style.Colors[ImGuiCol_TabActive] = ImVec4(0.47f, 0.62f, 0.85f, 1.00f);
		style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.25f, 0.35f, 0.55f, 0.70f);
		style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.30f, 0.45f, 0.70f, 0.85f);
		...
		// Checkmarks, sliders
		style.Colors[ImGuiCol_CheckMark] = ImVec4(0.36f, 0.65f, 0.95f, 1.00f);
		style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.35f, 0.50f, 0.70f, 1.00f);
		style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.47f, 0.62f, 0.85f, 1.00f);

		// Buttons
		style.Colors[ImGuiCol_Button] = ImVec4(0.35f, 0.50f, 0.70f, 1.00f);
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.40f, 0.55f, 0.80f, 1.00f);
		style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.47f, 0.62f, 0.85f, 1.00f);

		// Headers
		style.Colors[ImGuiCol_Header] = ImVec4(0.30f, 0.45f, 0.65f, 1.00f);
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.40f, 0.55f, 0.80f, 1.00f);
		style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.47f, 0.62f, 0.85f, 1.00f);

		// Separators
		style.Colors[ImGuiCol_Separator] = ImVec4(0.28f, 0.28f, 0.28f, 0.50f);
		style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.45f, 0.60f, 0.85f, 0.78f);
		style.Colors[ImGuiCol_SeparatorActive] = ImVec4(0.55f, 0.70f, 0.95f, 1.00f);

		// Resize grips
		style.Colors[ImGuiCol_ResizeGrip] = ImVec4(0.50f, 0.50f, 0.50f, 0.30f);
		style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.50f, 0.65f, 0.90f, 0.60f);
		style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(0.60f, 0.75f, 1.00f, 0.90f);
		...
		style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.35f, 0.50f, 0.70f, 1.00f);
		style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.47f, 0.62f, 0.85f, 1.00f);

		// Drag & drop
		style.Colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);

		// Navigation highlighting
		style.Colors[ImGuiCol_NavHighlight] = ImVec4(0.40f, 0.60f, 0.95f, 1.00f);
